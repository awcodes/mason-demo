<div class="not-prose branded bg-white @container">
    <div class="mx-auto grid w-full max-w-5xl px-6 grid-cols-1 gap-6 py-8 @3xl:py-12 @3xl:gap-10 @3xl:grid-cols-12 @3xl:gap-8">
